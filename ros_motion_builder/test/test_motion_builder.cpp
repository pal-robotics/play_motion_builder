...
{
  // Call edit service
  ros_motion_builder_msgs::EditMotion srv_edit;
  ASSERT_TRUE(ros::service::waitForService("ros_motion_builder_node/edit_motion",
                                           ros::Duration(5.0)));
  ros::service::call<ros_motion_builder_msgs::EditMotion>(
      "ros_motion_builder_node/edit_motion", srv_edit);
  EXPECT_FALSE(srv_edit.response.ok);
  EXPECT_EQ("No motion being built", srv_edit.response.message);

  // Call Store service
  ros_motion_builder_msgs::StoreMotion srv_store;
  ASSERT_TRUE(ros::service::waitForService("ros_motion_builder_node/store_motion",
                                           ros::Duration(5.0)));
  ros::service::call<ros_motion_builder_msgs::StoreMotion>(
      "ros_motion_builder_node/store_motion", srv_store);
  ...
  ros_motion_builder_msgs::ChangeJoints srv_change_joints;
  ASSERT_TRUE(ros::service::waitForService("ros_motion_builder_node/change_joints",
                                           ros::Duration(5.0)));
  ros::service::call<ros_motion_builder_msgs::ChangeJoints>(
      "ros_motion_builder_node/change_joints", srv_change_joints);
  EXPECT_FALSE(srv_change_joints.response.ok);
  EXPECT_EQ("No motion being built", srv_change_joints.response.message);

  // Call play action
  ros::NodeHandle nh;
  ros_motion_builder_msgs::RunMotionGoal rmg;
  actionlib::SimpleActionClient<ros_motion_builder_msgs::RunMotionAction> client(
      nh, "ros_motion_builder_node/run");
...
TEST(MotionBuilderTest, buildNewMotion)
{
  ...
  ros::NodeHandle nh;
  actionlib::SimpleActionClient<ros_motion_builder_msgs::BuildMotionAction> client(
      nh, "ros_motion_builder_node/build");

  ASSERT_TRUE(client.waitForServer(ros::Duration(5.0))) << "Server didn't start";

  // Send an empty goal.motion to start a new one
  ros_motion_builder_msgs::BuildMotionGoal goal;
  ...
  ros_motion_builder_msgs::EditMotion srv_edit;
  srv_edit.request.action = ros_motion_builder_msgs::EditMotion::Request::LIST;
  ros::service::call<ros_motion_builder_msgs::EditMotion>(
      "ros_motion_builder_node/edit_motion", srv_edit);
  // Check list is empty
  ...
  srv_edit.request.action = ros_motion_builder_msgs::EditMotion::Request::APPEND;
  ros::service::call<ros_motion_builder_msgs::EditMotion>(
      "ros_motion_builder_node/edit_motion", srv_edit);
  ...
  ros::Duration(0.15).sleep();  // Wait a bit for the change to take effect
  srv_edit.request.action = ros_motion_builder_msgs::EditMotion::Request::EDIT;
  ...
  srv_edit.request.action = ros_motion_builder_msgs::EditMotion::Request::COPY_AS_LAST;
  srv_edit.request.step_id = 0;
  ros::service::call<ros_motion_builder_msgs::EditMotion>(
      "ros_motion_builder_node/edit_motion", srv_edit);
  // Check list has one element
  ...
  srv_edit.request.action = ros_motion_builder_msgs::EditMotion::Request::COPY_AS_NEXT;
  ...
  // Remove motion 2
  srv_edit.request.action = ros_motion_builder_msgs::EditMotion::Request::REMOVE;
...
TEST(MotionBuilderTest, editExistingMotion)
{
  ...
  srv_edit.request.action = ros_motion_builder_msgs::EditMotion::Request::EDIT_TIME;
  srv_edit.request.step_id = 1;
