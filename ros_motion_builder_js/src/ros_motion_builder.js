...
/**
 * The class Motionbuilder contains the necessry methods to interface with the ros_motion_builder node.
 * 
...
class MotionBuilder {
	constructor(host, port) {
		...
		this.builder_client = new ROSLIB.ActionClient({
			ros: this.ros,
			actionName: 'ros_motion_builder_msgs/BuildMotionAction',
			serverName: '/ros_motion_builder_node/build'
		});
		this.build_goal = null;

		this.run_motion_client = new ROSLIB.ActionClient({
			ros: this.ros,
			actionName: 'ros_motion_builder_msgs/RunMotionAction',
			serverName: '/ros_motion_builder_node/run'
		});

		// Services
		this.list_joints_client = new ROSLIB.Service({
			ros: this.ros,
			serviceType: 'ros_motion_builder_msgs/ListJointGroups',
			name: '/ros_motion_builder_node/list_joint_groups'
		});
		this.edit_motion_client = new ROSLIB.Service({
			ros: this.ros,
			serviceType: 'ros_motion_builder_msgs/EditMotion',
			name: '/ros_motion_builder_node/edit_motion'
		});
		this.change_joints_client = new ROSLIB.Service({
			ros: this.ros,
			serviceType: 'ros_motion_builder_msgs/ChangeJoints',
			name: '/ros_motion_builder_node/change_joints'
		});
		this.store_client = new ROSLIB.Service({
			ros: this.ros,
			serviceType: 'ros_motion_builder_msgs/StoreMotion',
			name: "/ros_motion_builder_node/store_motion"
		});
